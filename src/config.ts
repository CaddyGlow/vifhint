...
export const appConfig = {
	keyBindings: {
		...
		bindings: [
			...
			// Scroll operations
			{ keys: 'd', operation: 'scroll:half-down', description: 'Scroll half page down', repeatable: true },
			{ keys: 'u', operation: 'scroll:half-up', description: 'Scroll half page up', repeatable: true },
